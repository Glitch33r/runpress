 ...
 */
trait sidebarSeoBundleTrait
{
    /**
     * @return array
     */
    private function seoBundlePathForEdit(): array
    {
        return [
            'seo_page' => 'seo-page/edit/'
        ];
    }
     ...
     * @return array
     */
    private function seoBundleRouteName(): array
    {
        return [
            'seo_page' => [
     ...
     * @return array
     */
    private function seoBundleRoles(): array
    {
        return [
            'seo' => 'ROLE_SEO'
        ];
     ...
     * @return array|null
     */
    private function sidebarSeoBundle(): ?array
    {
        return self::itemSidebar([
            self::seoBundleRoles()['seo']
        ], [
            self::seoBundlePathForEdit()['seo_page']
        ], [
            self::seoBundleRouteName()['seo_page']['index'], self::seoBundleRouteName()['seo_page']['new']
        ], 'flaticon-stopwatch', false, null, null,
            'sidebar.configuration.seo', [], self::seoBundleRouteName()['seo_page']['index'], 'SeoBundle',
