...
final class NewsController extends CRUDController
{
    ...
    public function getHeadTitle(): string
    {
        return
            ...
            . ' > ' .
            $this->translator->trans('Все материалы', [], 'NewsBundle');
    }
    ...
    public function getListElementsForIndexDashboard(TranslatorInterface $translator): array
    {
        return [
            ...
            'yandexRss' => ['title' => 'В Яндекс Новости', 'width' => 60],
            ...
            'sharing' => [
                'exist' => false,
                'title' => $this->translator->trans('ui.sharing', [], 'DashboardBundle')
            ],
    ...
    public function createDataForList($item, Environment $twig): array
    {
        ...
        return [
            ...
            'yandexRss' => $twig->render('@Dashboard/default/crud/list/element/_yes_no.html.twig', [
                'element' => $item, 'fieldName' => 'yandexRss'
            ]),
            'views' => $item->getViews(),
            ...
            'sharing' => $this->twig->render('@News/dashboard/news/list/_sharing.html.twig', [
                'element' => $item
            ]),
    ...
    public function customActionForList($item): string
    {
        ...
        return $this->twig->render('@News/dashboard/news/list/_custom_action.html.twig', [
            'news' => $id,
